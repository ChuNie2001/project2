...
By performing the linear regression model, we get the MSE of 0.06281474, indicating the model yields a good prediction. In cross-validation, we get the MSE of 0.07616929. Thus, there is no overfitting in this model. 
